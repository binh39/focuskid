...
export default function BreakScreen() {
  ...
  const activities = [
    { icon: Coffee, label: "Drink water", color: "#819D94" },
    { icon: Wind, label: "Deep breathing", color: "#819D94" },
    { icon: Smile, label: "Stretch your body", color: "#DD2203" },
  ];

  return (
    <div className="min-h-screen bg-[#FAFAFA] flex items-center justify-center">
      <div className="w-full max-w-2xl px-12 py-12 space-y-10 bg-[#819D94] rounded-[2rem] shadow-2xl">
        <motion.div
          initial={{ scale: 0 }}
          animate={{ scale: 1 }}
        ...
        {!isBreakActive ? (
          ...
          >
            ...
            <motion.button
              ...
              className="w-full bg-[#DD2203] text-white rounded-2xl py-4 px-6 shadow-lg hover:bg-[#7C1419] hover:shadow-xl transition-shadow flex items-center justify-center gap-2"
            >
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              onClick={() => navigate("/dashboard")}
              className="w-full bg-white text-[#819D94] rounded-2xl py-4 px-6 shadow-lg hover:shadow-xl transition-shadow"
            >
              Continue Learning
            </motion.button>
          </motion.div>
