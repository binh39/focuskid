...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-[#4A90E2] flex items-center justify-center">
      <div className="w-full max-w-[1200px] mx-auto px-12 py-16">
          ...
          >
            <div className="bg-white rounded-3xl shadow-2xl p-10 space-y-6">
              <div className="text-center space-y-2">
                <h2 className="text-3xl font-bold text-[#1F2937]">Welcome Back!</h2>
                <p className="text-[#6B7280]">Sign in to continue your learning adventure</p>
              </div>

              <div className="space-y-3">
                <button
                  onClick={handleLogin}
                  className="w-full bg-white border-2 border-[#E5E7EB] hover:border-[#4A90E2] rounded-xl py-3 px-5 flex items-center justify-center gap-3 transition-all shadow-sm hover:shadow-md"
                >
                  <Chrome className="w-5 h-5 text-[#4A90E2]" />
                  <span className="text-[#1F2937]">Sign in with Google</span>
                </button>
                ...
                >
                  ...
                  <span className="text-[#1F2937]">Sign in with Email</span>
                </button>
              </div>
              ...
              <button
                onClick={handleLogin}
                className="w-full bg-[#4A90E2] text-white rounded-xl py-3 px-5 shadow-lg hover:shadow-xl transition-shadow"
              >
                Start Learning
              </button>

              <div className="flex items-center justify-between text-sm pt-2">
                <button className="text-[#6B7280] hover:text-[#4A90E2] transition-colors">
                  Forgot password?
                </button>
                <button
                  onClick={handleLogin}
